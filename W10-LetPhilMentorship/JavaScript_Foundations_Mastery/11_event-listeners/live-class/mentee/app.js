...
function handleBioInput(event) {
  ...
  charCount.textContent = `${charValue} / 200`;
...
function updateSkillCount() {
  ...
  textContent = skillsList.children.length;
}
...
submit.addEventListener("submit", addSkillToPage);
...
document.getElementById("add-skill-form").addEventListener("submit", handleSkillSubmit);
...
document.getElementById("key-output").addEventListener("keydown", handleKeyDown);
