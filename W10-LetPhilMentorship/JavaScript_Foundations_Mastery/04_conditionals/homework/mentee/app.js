...
const studentName = "Benny"; // that is the name and doesn't change
const maxScore = 100; // maximum score is 100 and you can't change it
const passingScore = 60; // minimum score to pass, doesn't change
let earnedScore = 73; // the score earned, score changes based on performance
let isExtraCredit = false; // whether extra credit earned is based on student performace
...
if (earnedScore && attendancePercent >= minAttendance) {
...
if (percentage >= 90 && !hasDisciplinaryNote) {
