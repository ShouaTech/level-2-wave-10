...
// What's wrong ↓
  // the error is the capital C in product.category
// Your fix ↓
  // console.log(product.category);
...
// What's wrong ↓
  // similarly, a punctuation issue, with name and price needing to be lowercase in the array 
// Your fix ↓
  //  const inventory = [
  // { name: "shirt", price: 29.99},
  // { name: "Jeans", price: 59.99},
...
// Bug 1 ↓
  // products.stock on line 68 should be products[i].stock
// Bug 2 ↓
  // for loop shouldn't be i <= products.length, but i < products.length
// Your fix ↓
