...
if (user.login) {
  console.log("lastLogin is truthy");
} else {
  console.log("lastLogin is falsy");
}
...
// I believe "0" is truthy because its a string, which contains a value of a character within it
...
// first one is true because it isn't strict, contains the same value
// second one is false because it's strict, checks the type, which in this case one is a number and the other is a string 

// b
console.log(0 == false); // true
console.log(0 === false); // false
// first one is true because booleans are converted to numbers when it needs a numeric value  
// second one is false because 0 is a number, and false is a boolean

// c
console.log("" == false); // true
console.log("" === false); // false
// first one is true because its an empty string, no characters inside making it falsey
// second one is false because it's still a string, and false is a boolean

// d
console.log(null == undefined); // true
console.log(null === undefined); // false
// first one is true because null is purposely set to nothing
// second one is false because null is an object, undefined is undefined

// e
console.log(null == 0); // false
console.log(null === 0); // false
// both are false because null doesn't loosely or strictly equal a number

// For each pair: why does == give a different answer than ===?

// Because == is a loose equality operator which checks only the value
// While === is a strict equality operator that checks for the same type and value
...
function formatProfile(user) {
  firstName = "Benny",
  lastName = "Yang",
  email = "BENNYANG@HOTMAIL.COM",
  age = 26,
  bio = "future 7 figure Software Engineer",
  isPremium = true,
  score = 95,
  lastLogin = null
};
